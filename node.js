...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $optimade_zero_api.prototype, "filters", null);
    __decorate([
        $mol_mem
...
var $;
(function ($) {
    class $optimade_zero_api_entity extends $mol_store {
        cdn_uri() {
    ...
    $.$optimade_zero_api_entity = $optimade_zero_api_entity;
})($ || ($ = {}));
...
;
	...
	($mol_mem_key(($.$optimade_zero_search.prototype), "clear_search_filter"));
	($mol_mem_key(($.$optimade_zero_search.prototype), "Search_labeler_content"));
	...
	($mol_mem(($.$optimade_zero_search.prototype), "Search"));
	($mol_mem(($.$optimade_zero_search.prototype), "fetch_search"));
	($mol_mem(($.$optimade_zero_search.prototype), "Search_button"));
	($mol_mem(($.$optimade_zero_search.prototype), "Search_row"));
	($mol_mem(($.$optimade_zero_search.prototype), "search_type"));
	($mol_mem(($.$optimade_zero_search.prototype), "View_type_switch"));
	($mol_mem(($.$optimade_zero_search.prototype), "View_type_row"));
	($mol_mem_key(($.$optimade_zero_search.prototype), "Image"));
	($mol_mem_key(($.$optimade_zero_search.prototype), "Classes"));
	($mol_mem_key(($.$optimade_zero_search.prototype), "Description"));
	($mol_mem_key(($.$optimade_zero_search.prototype), "Facet_info"));
	($mol_mem_key(($.$optimade_zero_search.prototype), "Card"));
	($mol_mem(($.$optimade_zero_search.prototype), "Row_cards"));
	($mol_mem(($.$optimade_zero_search.prototype), "Result_page"));
	($mol_mem(($.$optimade_zero_search.prototype), "mpds_api"));
...
;
	($.$optimade_zero) = class $optimade_zero extends ($.$mol_book2_catalog) {
		Logo_link(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("");
			(obj.title) = () => ("−273.15°C");
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/Lyumih/absolute-zero");
			return obj;
		}
		Menu_title(){
	...
	($mol_mem(($.$optimade_zero.prototype), "Logo_link"));
	($mol_mem(($.$optimade_zero.prototype), "Theme"));
	($mol_mem(($.$optimade_zero.prototype), "Search_page"));
	($mol_mem(($.$optimade_zero.prototype), "Lights"));
	($mol_mem(($.$optimade_zero.prototype), "Sources"));
...
var $;
(function ($) {
    $mol_style_attach("optimade/zero/zero.view.css", "[optimade_zero] {\n\tfont-family: 'Exo 2', 'Segoe UI',\n\t\tTahoma,\n\t\tGeneva,\n\t\tVerdana,\n\t\tsans-serif;\n}\n");
})($ || ($ = {}));
