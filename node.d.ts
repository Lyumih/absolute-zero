...
declare namespace $ {
	...
	>
	type $mol_labeler__title_optimade_zero_search_2 = $mol_type_enforce<
		ReturnType< $optimade_zero_search['search_labeler_title'] >
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_optimade_zero_search_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_button_major__hint_optimade_zero_search_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['hint'] >
	>
	type $mol_button_major__click_optimade_zero_search_5 = $mol_type_enforce<
		ReturnType< $optimade_zero_search['clear_search_filter'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub_optimade_zero_search_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_row__sub_optimade_zero_search_7 = $mol_type_enforce<
		ReturnType< $optimade_zero_search['search_filters'] >
		,
	...
	export class $optimade_zero_search extends $mol_book2 {
		...
		Classes( id: any): $mol_html_view
		get_description( id: any): string
		Description( id: any): $mol_html_view
		Facet_info( id: any): $mol_list
		Card( id: any): $mol_row
...
declare namespace $ {
	...
	type $mol_link__uri_optimade_zero_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__title_optimade_zero_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link_source__uri_optimade_zero_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	export class $optimade_zero extends $mol_book2_catalog {
		Logo_link( ): $mol_link
		Theme( ): $mol_theme_auto
		Search_page( ): $optimade_zero_search
		Lights( ): $mol_lights_toggle
		Sources( ): $mol_link_source
		Menu_title( ): ReturnType< $optimade_zero['Logo_link'] >
		param( ): string
		plugins( ): readonly(any)[]
		spreads( ): ({ 
			'search': ReturnType< $optimade_zero['Search_page'] >,
		}) 
		menu_foot( ): readonly(any)[]
	}
