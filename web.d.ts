...
declare namespace $ {
	...
	type $mol_image__uri_azero_app_search_21 = $mol_type_enforce<
		...
		ReturnType< $mol_image['uri'] >
	>
	type $mol_html_view__html_azero_app_search_22 = $mol_type_enforce<
		ReturnType< $azero_app_search['get_classes'] >
		,
		ReturnType< $mol_html_view['html'] >
	>
	type $mol_html_view__html_azero_app_search_23 = $mol_type_enforce<
		ReturnType< $azero_app_search['get_description'] >
		,
		ReturnType< $mol_html_view['html'] >
	>
	type $mol_list__rows_azero_app_search_24 = $mol_type_enforce<
		...
		ReturnType< $mol_list['rows'] >
	>
	type $mol_row__sub_azero_app_search_25 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_list__rows_azero_app_search_26 = $mol_type_enforce<
...
declare namespace $ {
	...
	>
	type $mol_link__title_azero_app_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link_source__uri_azero_app_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	export class $azero_app extends $mol_book2_catalog {
		Logo_link( ): $mol_link
		Theme( ): $mol_theme_auto
		Search_page( ): $azero_app_search
		Lights( ): $mol_lights_toggle
		Sources( ): $mol_link_source
		Menu_title( ): ReturnType< $azero_app['Logo_link'] >
		param( ): string
		plugins( ): readonly(any)[]
		spreads( ): ({ 
			'search': ReturnType< $azero_app['Search_page'] >,
		}) 
		menu_foot( ): readonly(any)[]
	}
